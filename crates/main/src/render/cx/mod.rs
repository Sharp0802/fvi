...
use crate::render::cx::device::RenderDevice;
use crate::render::layer::LayerVec;
use crate::render::{InitError, RenderError};
...
impl RenderContext {
    ...
    pub async fn new(
        ...
        let layers = LayerVec::new(&device, format.add_srgb_suffix(), size, config.layer_count);
    ...
    pub async fn render(&mut self) -> Result<(), RenderError> {
...

        {
            ...
            pass.execute_bundles([self.layers.bundle()]);
        }
